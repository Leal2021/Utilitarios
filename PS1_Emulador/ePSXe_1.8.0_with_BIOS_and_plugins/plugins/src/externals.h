...
// complete sound buffer (~24 sec)
#define SOUNDSIZE			0x400000
#define UPLOADSIZE		SOUNDLEN(2)


// test buffer... if less than that is buffered, a new upload will happen
#define LATENCY				((iLatency+1) * 10)

#define TESTMIN				UPLOADSIZE
#define TESTMAX				SOUNDLEN( LATENCY + 30 )

#define FULLMIN				UPLOADSIZE
#define FULLMAX				SOUNDLEN( LATENCY + 60 )
